...
const int nPointsCirlces = 20; // Exercicio 8: alterado para 8 na letra a) e 5 na letra b).
...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// glDrawArrays(GL_LINE_LOOP, 0, nPointsCirlces);
...
int setupGeometry()
{
	...
	GLfloat vertices[3 * nPoints];

	// Para letra c, utilizar abaixo:
	// angle = M_PI / 9.0f;
    // GLfloat vertices[3 * (nPoints + 2)]; // Include center vertex
    // vertices[0] = 0.0f;  // Center point
    // vertices[1] = 0.0f;
    // vertices[2] = 0.0f;
	// for (int i = 1; i <= nPoints + 1; i++) {
	// Para a letra d, faz-se basicamente o oposto da letra c, definindo um angulo de inicio e um de fim.
