...
//#endif
	...
	// Exercício 5, definicao do viewport movida para o game loop
	...
	// Exercício 2:
	// Modificando a janela (window/ortho) para os limites: xmin=0, xmax=800, ymin=600, ymax=0 (limites iguais ao tamanho da janela em pixels)
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Exercício 5, alterar o viewport para cada quadrante e desenhar o triangulo.
		// superior esquerdo
